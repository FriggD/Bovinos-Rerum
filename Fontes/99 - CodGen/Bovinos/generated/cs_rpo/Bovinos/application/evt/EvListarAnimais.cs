...
namespace application.evt
{
	...
	/// <summary>
	/// Evento negocial EvListarAnimais.
	/// </summary>
    /// <Author>gmdias</Author>
    /// <Created>2021-01-07T10:08:07-03:00</Created>
    /// <Modified>2021-01-07T10:15:38-03:00</Modified>
	public class EvListarAnimais : RTEvent
	//============================================================================================
	{
		#region Atributos
		/// <summary>
		/// NA
		/// </summary>
		private RTTList retornoConsultaLista = new RTTList();
		#endregion

		#region Get/Set Atributos
		public RTTList getRetornoConsultaLista() 
		{
			//<bucb> getRetornoConsultaLista()
			//<eucb> getRetornoConsultaLista()
			return retornoConsultaLista;
		}

		public void setRetornoConsultaLista(RTTList value) 
		{
			//<bucb> setRetornoConsultaLista(RTTList value)
			//<eucb> setRetornoConsultaLista(RTTList value)
			this.retornoConsultaLista = value;
		}

		/// <summary>
		/// NA
		/// </summary>
		public RTTList RetornoConsultaLista 
		{
			get { return getRetornoConsultaLista(); }
			set { setRetornoConsultaLista(value); }
		}
		#endregion
		...
		/// <summary>
		/// Construtor de EvListarAnimais. 
		/// </summary>
		public EvListarAnimais(TRNAnimal pTransaction, string pEventName) 
			: base(pTransaction, pEventName)
		{
			//<bucb>User Construtor_EvListarAnimais 
			//<eucb>User Construtor_EvListarAnimais
		}		
	...
	}  // End public class EvListarAnimais : EvRTEvent
