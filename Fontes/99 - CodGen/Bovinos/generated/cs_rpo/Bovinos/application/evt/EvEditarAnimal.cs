...
namespace application.evt
{
	...
	/// <summary>
	/// Evento negocial EvEditarAnimal.
	/// </summary>
    /// <Author>gmdias</Author>
    /// <Created>2021-01-07T10:07:14-03:00</Created>
    /// <Modified>2021-01-07T10:15:38-03:00</Modified>
	public class EvEditarAnimal : RTEvent
	//============================================================================================
	{
		#region Atributos
		/// <summary>
		/// NA
		/// </summary>
		private Animal animalEditar = new Animal();
		#endregion

		#region Get/Set Atributos
		public Animal getAnimalEditar() 
		{
			//<bucb> getAnimalEditar()
			//<eucb> getAnimalEditar()
			return animalEditar;
		}

		public void setAnimalEditar(Animal value) 
		{
			//<bucb> setAnimalEditar(Animal value)
			//<eucb> setAnimalEditar(Animal value)
			this.animalEditar = value;
		}

		/// <summary>
		/// NA
		/// </summary>
		public Animal AnimalEditar 
		{
			get { return getAnimalEditar(); }
			set { setAnimalEditar(value); }
		}
		#endregion
		...
		/// <summary>
		/// Construtor de EvEditarAnimal. 
		/// </summary>
		public EvEditarAnimal(TRNAnimal pTransaction, string pEventName) 
			: base(pTransaction, pEventName)
		{
			//<bucb>User Construtor_EvEditarAnimal 
			//<eucb>User Construtor_EvEditarAnimal
		}		
	...
	}  // End public class EvEditarAnimal : EvRTEvent
