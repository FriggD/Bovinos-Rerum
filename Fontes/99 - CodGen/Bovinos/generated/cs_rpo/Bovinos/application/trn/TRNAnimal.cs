...
namespace application.trn
{
	...
	//============================================================================================
	{
        ...
        protected virtual T GetEventByName<T>(string pEventName) where T : RTEvent
        {
            ...
            if (evt == null || !string.IsNullOrWhiteSpace(pEventName))
            {
                switch (pEventName)
                {
                    ...
                    case K_EV_NAME_CadastrarAnimal: evt = new EvCadastrarAnimal(this, K_EV_NAME_CadastrarAnimal) as T; break;
		...
		{
			var evt = GetEventByName<EvCadastrarAnimal>(K_EV_NAME_CadastrarAnimal);
