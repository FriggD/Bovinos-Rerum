...
namespace application.evt
{
	...
	/// <summary>
	/// Evento negocial EvCadastraAnimal.
	/// </summary>
    /// <Author>gmdias</Author>
    /// <Created>2021-01-07T10:06:57-03:00</Created>
    /// <Modified>2021-01-07T10:15:38-03:00</Modified>
	public class EvCadastraAnimal : RTEvent
	//============================================================================================
	{
		#region Atributos
		/// <summary>
		/// NA
		/// </summary>
		private Animal animalCadastro = new Animal();
		#endregion

		#region Get/Set Atributos
		public Animal getAnimalCadastro() 
		{
			//<bucb> getAnimalCadastro()
			//<eucb> getAnimalCadastro()
			return animalCadastro;
		}

		public void setAnimalCadastro(Animal value) 
		{
			//<bucb> setAnimalCadastro(Animal value)
			//<eucb> setAnimalCadastro(Animal value)
			this.animalCadastro = value;
		}

		/// <summary>
		/// NA
		/// </summary>
		public Animal AnimalCadastro 
		{
			get { return getAnimalCadastro(); }
			set { setAnimalCadastro(value); }
		}
		#endregion
		...
		/// <summary>
		/// Construtor de EvCadastraAnimal. 
		/// </summary>
		public EvCadastraAnimal(TRNAnimal pTransaction, string pEventName) 
			: base(pTransaction, pEventName)
		{
			//<bucb>User Construtor_EvCadastraAnimal 
			//<eucb>User Construtor_EvCadastraAnimal
		}		
	...
	}  // End public class EvCadastraAnimal : EvRTEvent
